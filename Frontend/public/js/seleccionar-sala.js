document.addEventListener('DOMContentLoaded', () => {
    ...
    try {
        ...
        if (roomOptions) {
            ...
            if (userInfo.id >= 1 && userInfo.id <= 11) {
                roomOptions.innerHTML = `
                    <button id="create-room">Crear Nueva Sala</button>
                `;
            } else if (userInfo.id >11 && userInfo.id <= 45) {
                roomOptions.innerHTML = `
                    <div class="join-room">
        ...
        if (userInfo.id >= 1 && userInfo.id <= 11 && createRoomBtn) {
        ...
        if (userInfo.id >11  && userInfo.id <= 45 && joinRoomBtn && roomIdInput) {
