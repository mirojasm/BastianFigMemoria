...
const fullText = `En el vasto campo de la inteligencia artificial, el aprendizaje automático ha emergido como una de las áreas más prometedoras y transformadoras. Esta tecnología, que permite a las computadoras aprender de la experiencia sin ser programadas explícitamente, está revolucionando múltiples sectores, desde la atención médica hasta el transporte. Los sistemas de aprendizaje automático pueden analizar grandes cantidades de datos, identificar patrones y hacer predicciones con una precisión cada vez mayor. A medida que la tecnología continúa evolucionando, su impacto en la sociedad se hace cada vez más profundo, planteando tanto oportunidades como desafíos éticos que debemos abordar colectivamente.`;
